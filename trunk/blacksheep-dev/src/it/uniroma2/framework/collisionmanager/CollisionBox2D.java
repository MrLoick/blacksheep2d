package it.uniroma2.framework.collisionmanager;
...
public class CollisionBox2D implements Runnable{
	...
	private ArrayList<PhysicsObj> listPhysicsObj;
	...
	private CollisionBox2D(){
	        ...
	        listPhysicsObj=new ArrayList<PhysicsObj>();
	...
	public void destroy(PhysicsObj physicsObj){
